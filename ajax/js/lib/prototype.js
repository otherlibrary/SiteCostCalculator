    ...
    if (['THEAD','TBODY','TR','TD'].indexOf(tagName) > -1) {
      ...
      switch (tagName) {
        ...
        case 'TBODY':
          ...
          break;
        case 'TR':
          div.innerHTML = '<table><tbody><translate>' +  html.stripScripts() + '</translate></tbody></table>';
          depth = 3;
          break;
        case 'TD':
          div.innerHTML = '<table><tbody><translate><td>' +  html.stripScripts() + '</td></translate></tbody></table>';
          depth = 4;
      }
