...
$linksTotal = $seo->Google_Backlinks_Total();
if ($linksTotal != 'error' && $linksTotal != '0') {
$googleBackLinksArray = $seo->Google_Backlinks_Array();
$arr = array();
$count = 0;
...
$backsOut .= $backsOut.$linksTotal;
	$sql = "UPDATE worth SET worth.google_links = '$backsOut' WHERE domain='$domain' LIMIT 1";
	$rs_result = mysql_query($sql);
} else {
	$sql = "UPDATE worth SET worth.google_links = '0' WHERE domain='$domain'";
	$rs_result = mysql_query($sql);
