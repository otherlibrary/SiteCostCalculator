...
if ($Security->IsLoggedIn()) {
	Page_Terminate("adminlist.php"); // Exit and go to default page
}
if ($Security->IsLoggedIn()) {
	Page_Terminate("commentslist.php");
}
if ($Security->IsLoggedIn()) {
	Page_Terminate("filterlist.php");
}
if ($Security->IsLoggedIn()) {
	Page_Terminate("ratingslist.php");
}
if ($Security->IsLoggedIn()) {
	Page_Terminate("worthlist.php");
}
if ($Security->IsLoggedIn()) {
?>
