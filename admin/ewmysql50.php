 ...
 */
$EziScript_vers = 'v5.0.0 EziScript (C) 2002-2007 e.World Technology Limited';
...
class ADOConnection
{
	...
	/**
	 * Returns floating point version number of EziScript
	 * Usage: $db->Version();
	 * 
	 * @access public 
	 */
	...
	function Version()
	{
		global $EziScript_vers;
		return (float) substr($EziScript_vers,1);
	}
