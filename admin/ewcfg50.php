...
/**
 * EziScript configuration file
 */

// Database connection
define("EW_CONN_HOST", "$db_host", TRUE);
define("EW_CONN_PORT", 3306, TRUE);
define("EW_CONN_USER", "$db_username", TRUE);
define("EW_CONN_PASS", "$db_password", TRUE);
define("EW_CONN_DB", "$database", TRUE);
...
define("EW_RANDOM_KEY", '$7X#2#AB2RHj5T86', TRUE); // Random key for encryption
...
define("EW_SENDER_EMAIL", "admin@eziscript.com", TRUE); // Sender email
