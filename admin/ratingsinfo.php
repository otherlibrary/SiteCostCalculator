...
// EziScript configuration for Table ratings
$ratings = new cratings; // Initialize table object
...
class cratings {
	...
	function cratings() {
		$this->TableVar = "ratings";
		$this->TableName = "ratings";
		$this->SelectLimit = TRUE;
		$this->id = new cField('ratings', 'x_id', 'id', "`id`", 3, -1, FALSE);
		$this->fields['id'] =& $this->id;
		$this->rating = new cField('ratings', 'x_rating', 'rating', "`rating`", 3, -1, FALSE);
		$this->fields['rating'] =& $this->rating;
		$this->domain = new cField('ratings', 'x_domain', 'domain', "`domain`", 201, -1, FALSE);
		$this->fields['domain'] =& $this->domain;
		$this->id_2 = new cField('ratings', 'x_id_2', 'id_2', "`id_2`", 3, -1, FALSE);
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `ratings` ($names) VALUES ($values)";
	}
	...
	// View url
	function ViewUrl() {
		return $this->KeyUrl("ratingsview.php");
	}

	// Edit url
	function EditUrl() {
		return $this->KeyUrl("ratingsedit.php");
	}

	// Inline edit url
	function InlineEditUrl() {
		return $this->KeyUrl("ratingslist.php", "a=edit");
	}

	// Copy url
	function CopyUrl() {
		return $this->KeyUrl("ratingsadd.php");
	}

	// Inline copy url
	function InlineCopyUrl() {
		return $this->KeyUrl("ratingslist.php", "a=copy");
	}

	// Delete url
	function DeleteUrl() {
		return $this->KeyUrl("ratingsdelete.php");
	}
	...
	function RenderListRow() {
		...
		$this->rating->CssStyle = "";
		$this->rating->CssClass = "";
