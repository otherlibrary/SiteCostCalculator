...
$f4__ = "Basic computing..";
$f5 = "Got it!<br> One second, please..";
$f6 = "<h1>Hmm..</h1><h2>Seems JavaScript has been disabled? Why? Site works properly with it and it is safe, trust me!</h2><h3>So plug it on and enjoy surfing SiteCostCalculator ;)</h3>";
$f7 = "Last Calculated";
$f8 = "Top sites";
...
$mobTitle2 = "Mobile version";
$mobTitle3 = "Full version";
$shareit = "How much is your website";
$help1_ = "I need your free help, friends";
$help2_ = "let's make this website better";
$battle1 = "Websites Battle";
$battle2 = "Please, provide 2 or more websites (each in new line):";
$battle3 = "Link to this battle:";
$battle4 = "Unknown sites:";
$battle5 = "Use 'refresh' buttons to calculate them. Remove wrong domains (if any) and request Battle again (using form below):";
$battleGo = "Fight!";
$nBattle = "Websites Battle. Whos site more valuable?";
$battle6 = "Participants";
$battle7 = "Winners";
$battle8 = "Latest results:";
$battle9 = "link";
$battle10 = "Battle!";
$cSaid = "wrote";
...
$cComments_ = "Comments";
$cNo = "No comments";
$cName_ = "Your name (optional)";
$cSite_ = "Your website (optional)";
$cComm_ = "Comment (HTML tags will be deleted)";
$cSubmit_ = "Submit";
$cFrom_ = "from";
$wname1_ = "Is your name the most popular?";
$wname2_ = ">>> check it <<<";
$wname3_ = "http://whatisyourname.me/";
$needUpdate1 = "This website has been calculated a long time ago";
$needUpdate2 = "..automatic update started..";
$underC = "Updating website engine. It will be online soon. Stay tuned :o)";
$ps = "Please note that the price does not include a specific situation on the IT market, as well as brand value or possible value of the company behind the site. Just a website's worth, based upon public statistics and how the domain/web site behaves from the visitor's point of view.";
$ps2 = "In order to find yourself as site CEO, just try to use your Facebook id, like ";
$saleUpd4 = "Scanning was prohibited by site owner.<br> If for various reason you don't want to get you site/domain crawled, just add this tag:<br> <b>&lt;meta name='scc.disable-scanner' content='yes' /&gt;</b>";
?>