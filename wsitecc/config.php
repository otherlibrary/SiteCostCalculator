<?php
$db_username = 'sitecost';         // Database Name    
$db_password = 's1ac2x1voFFka';         //  Database Password
$database = 'sitecost';            //  Database Username  
$db_host = 'sitecost.db.6308946.hostedresource.com';             //Database Host name or IP
