   	   ...
   	   <div class="content">
            ...
            <div class="menu">
            	<ul>
                	<li><a href="">Home</a></li>
                    <li><a href="">FAQ</a></li>
                    <li><a href="">Download Pagerank Script</a></li>
                    <li><a href="">Buy This Script</a></li>
                    	...
                    	<div class="inside_content">
                            <div class="top_content">
                                ...
                                <div class="text_box">
                                    <div class="left"></div>
                                    <div class="middle">
                                        <input type="text" onclick="clickclear(this, 'eg. www.google.com or http://www.youtube.com')" onblur="clickrecall(this,'eg. www.google.com or http://www.youtube.com')" value="eg. www.google.com or http://www.youtube.com" class="middle" />
                                    </div>
                                    <div class="right"></div>
                                </div>
...
This button will update the  website data. But this button will activate when &quot;last update is <?php echo $updateday; ?>  days ago&quot;. If listing is less then <?php echo $updateday; ?> days old then you cann't see this  button.</div>
		      ...
		      Let us get started.</span>
                    ...
                    <div class="footer">
                        ...
                        <div class="mid_foot">
                        	<h6><a href="http://eziscript.com" target="_blank">Website Design and Programing By: EziScript.com  Click to see more stats!</a></h6>
                            <h5><a href="http://eziscript.com" target="_blank">Domain Tools and Websiteoutlook Clone V1.5 Updated</a></h5>
                        </div>
